...
class GetRoomListControllerTest {
    ...
    void constructorHouseIsNull() {
        //Act + assert
        assertThrows(IllegalArgumentException.class, () -> new GetRoomListController(null, roomMapper1));
    ...
    void constructorRoomMapperIsNull() {
        //Act + assert
        assertThrows(IllegalArgumentException.class, () -> new GetRoomListController(house2, null));
