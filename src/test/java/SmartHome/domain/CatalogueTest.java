...
class CatalogueTest {
    ...
    void getSensorsCatalogue() throws InstantiationException {
        ...
        int expectedSize = 2;
        String firstSensor = "SmartHome.domain.sensors.SensorOfTemperature";
        String secondSensor = "SmartHome.domain.sensors.SensorOfHumidity";
        //Act
    ...
    void getActuatorsCatalogue() throws InstantiationException {
        ...
        Catalogue catalogue = new Catalogue(filePathname);
        int expectedSize = 3;
        String actuator = "SmartHome.domain.actuators.ActuatorOfOnOff";
        //Act
        List<String> result = catalogue.getActuatorsCatalogue();
        //Assert
        assertEquals(expectedSize, result.size());
        assertEquals(actuator, result.getFirst());
    }
