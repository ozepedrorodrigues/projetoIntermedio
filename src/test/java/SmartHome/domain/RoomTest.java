...
class RoomTest {
    ...
    /**
     * Test to verify that the constructor of the Room class throws an IllegalArgumentException when the DimensionsFactory is null.
     */
    @Test
    void roomConstructorNullDimensionsFactory() {
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> new Room(validRoomName, validFloor, validWidth, validLength, validHeight, null, deviceFactoryMock));
    }

    /**
     * Test to verify that the constructor of the Room class throws an IllegalArgumentException when the DeviceFactory is null.
     */
    @Test
    void roomConstructorNullDeviceFactory() {
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> new Room(validRoomName, validFloor, validWidth, validLength, validHeight, dimensionsFactoryMock, null));
    }
