...
public class Device {
    ...
    public Sensor addSensor(String sensorClassName) {
        if (!validClassName(sensorClassName) || !(this.active)) {
            return null;
        }
     ...
     * Also creates an Id for the actuator and adds it to the list of actuators.
     *
    ...
    public Actuator addActuator(String actuatorClassName) {
        if (!validClassName(actuatorClassName) || !active) {
            return null;
        }
