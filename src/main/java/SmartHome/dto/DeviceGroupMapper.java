...
public class DeviceGroupMapper {
     ...
     *
     * @param devicesByRoom  the list of {@link Device} grouped by {@link Room}.
     * @param sensorTypes the list of {@link SensorType} enum instances available
     * @return a map of {@link SmartHome.dto.DeviceDTO} (including roomName) grouped by functionality.
     */
